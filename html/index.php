    ...
    <div class="container theme-showcase" role="main">
        ...
        <form method="post">
            ...
            <div class="jumbotron">
                ...
                Atividade do projeto de capacitação Huawei, utilizando o Microsoft Azure.</p>
            </div>
            ...
            $conn = sqlsrv_connect($DB_HOST, $connectionOptions) or die
                ('<br><div class="alert alert-warning" role="alert">Não foi possivel conectar ao servidor SQL</div>');
